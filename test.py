...
class GameWindow(arcade.Window):
    ...
    def tilemap_load(self):
        ...
        self.blue_barier.enable_spatial_hashing(TILE_SIZE)
        ...
        self.background.enable_spatial_hashing(TILE_SIZE)
    ...
    def setup(self):
        ...
        # by damping.a
        self.laser = Laser("new_assets/user_int/emiter_projectile.png", SPRITE_SCALING_TILES, self.player_sprite.position)
